...
class StitchDecoder(object):
    ...
    def __init__(self, input_size, weights_path):
        ...
        conv = Conv2D(640, 3, activation='relu', padding='same', name='decoder_conv2')(conv)
        conv = Conv2DTranspose(320, 3, activation='relu', padding='same', name='decoder_conv3', strides=2)(conv)
        conv = Conv2D(320, 3, activation='relu', padding='same', name='decoder_conv4')(conv)
        conv = Conv2DTranspose(160, 3, activation='relu', padding='same', name='decoder_conv5', strides=2)(conv)
        conv = Conv2D(160, 3, activation='relu', padding='same', name='decoder_conv6')(conv)
        conv = Conv2DTranspose(80, 3, activation='relu', padding='same', name='decoder_conv7', strides=2)(conv)
        conv = Conv2D(80, 3, activation='relu', padding='same', name='decoder_conv8')(conv)
        conv = Conv2DTranspose(40, 3, activation='relu', padding='same', name='decoder_conv9', strides=2)(conv)
        conv = Conv2D(40, 3, activation='relu', padding='same', name='decoder_conv10')(conv)
