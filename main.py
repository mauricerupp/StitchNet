...
# name the model
NAME = str(u_net_convtrans_model4.__name__)
...
# setup the model
model = u_net_convtrans_model4.create_model(input_size=input_size)

# train the model
model.fit_generator(train_data_generator,  epochs=18, callbacks=[cp_callback, tensorboard],
