...
from stitch_decoder_Conv3D import *
...
# name the model
NAME = str(current_model.__name__) + "_3D_TEST"
...
# ----- Model setup ----- #
model = StitchDecoder(input_size,
                      '/data/cvg/maurice/logs/ConvAutoencoder_V6_instance_20_80_newcallback_run4/weight_logs/auto_weights-improvement-133.hdf5',
                      weights_path_big='/data/cvg/maurice/logs/ConvAutoencoder_BIG/weight_logs/auto_weights-improvement-60.hdf5',
                      normalizer='instance',
                      isTraining=True)
