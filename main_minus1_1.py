...
# name the model
NAME = str(current_model.__name__) + "1_INSTANCE"
...
# ----- Model setup ----- #
model = current_model.create_model(input_size=input_size, filter_size=128, block_amount=12, normalizer="instance")
