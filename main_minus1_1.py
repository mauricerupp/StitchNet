...
train_data_generator = batch_generator_minus1_1.MyGenerator(paths_dir_train + "/snaps_paths.npy",
                                                       paths_dir_train + "/targets_paths.npy", batchsize)
val_data_generator = batch_generator_minus1_1.MyGenerator(paths_dir_val + "/snaps_paths.npy",
