...
def create_model(pretrained_weights=None, input_size=None):
    ...
    conv1 = Conv2D(64, 11, activation='relu', padding='same', kernel_initializer='he_normal', dilation_rate=2)(conv1)
    ...
    conv3 = Conv2D(256, 9, activation='relu', padding='same', kernel_initializer='he_normal')(pool2)
    conv3 = Conv2D(256, 9, activation='relu', padding='same', kernel_initializer='he_normal', dilation_rate=2)(conv3)
